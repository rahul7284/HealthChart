...
public class UserServiceImpl implements UserService {
	...
	public UserDto saveUser(UserDto user) {
		...
		/*
		 * List<CBCModel> cbclist = new ArrayList<CBCModel>(); List<SugarModel>
		 * sugarlist = new ArrayList<SugarModel>(); List<ThyroidModel> thyroidlist = new
		 * ArrayList<ThyroidModel>(); List<HospitalModel> hosplist = new
		...
		/*
		 * cbclist =user.getCbcList(); sugarlist =user.getSugarList(); thyroidlist
		 * =user.getThyroidList(); hosplist =user.getHospitalList();
		 */
